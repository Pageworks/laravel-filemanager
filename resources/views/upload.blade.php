...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">API Token: <input type="text" id="input-csrf" size="50" style="border:1px solid;border-radius:3px;margin-bottom:15px;"></div>
                        <form action="/file-upload" class="dropzone" id="my-dropzone" style="width:500px;margin:0 auto;"></form>
    ...
    <script>
        new Uppy.Core().use(Uppy.Dashboard, {
            debug:true,
            /*
